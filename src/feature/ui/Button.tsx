  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border bg-white/90 shadow-xs dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
          "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80",
        ghost:
          "border-none shadow-[1px_1px_2px_0_rgba(152,152,152,0.25)] hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50 active:shadow-[inset_0_2px_2px_0_rgba(152,152,152,0.25)]",
        link: "text-primary underline-offset-4 hover:underline",
        shadow:
          "border-1 border-[#4C4C4C] rounded-xs text-[#4C4C4C] text-base font-semibold leading-[24.5px] shadow-[4px_4px_0_0_rgba(102,102,102,0.6)]",
        none: "",
      },
      size: {
